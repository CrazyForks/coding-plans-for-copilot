...
export const COPY_MODEL_AS_CHAT_LANGUAGE_MODELS_COMMAND = 'coding-plans.copyModelAsChatLanguageModel';
...
export const REASONING_EFFORT_MODEL_OPTION_KEY = 'reasoningEffort';
export const EFFORT_MODEL_OPTION_KEY = 'effort';
export const THINKING_TYPE_MODEL_OPTION_KEY = 'thinkingType';
export const ENABLE_THINKING_MODEL_OPTION_KEY = '_enableThinking';
