...
| ID | Given | When | Then |
| --- | --- | --- | --- |
| A1 | 模型协议风格为 `openai-chat` | VS Code 请求 `LanguageModelChatInformation` | `configurationSchema.properties.thinkingEffort.default` 为 `high`，`thinkingType.default` 为 `default` |
...
sequenceDiagram
    ...
    Adapter-->>VSCode: thinkingEffort default high, thinkingType default default
